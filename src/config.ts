...
export const siteConfig: SiteConfig = {
	title: "CTF Writeups",
	subtitle: "CTF Writeup Collection",
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/arshakir/ctfs", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	name: "Abdur-Rahman Shakir",
	links: [
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/arshakir",
		},
	],
};
